...
<div class="page">
    <!-- Page content-->
    <section class="section section-single bg-gray-800" style="background-image: url(/images/bg-image-3.jpg);">
        <div class="section-single-inner">
                    ...
                    <div class="row row-30">
                        ...
                        <div class="col-sm-6">
                            <div class="section-single-main-content">
                                ...
                                <p><span class="text-width-2">You may have mistyped the address or the page may have moved.</span></p><a class="button button-lg button-primary button-winona" href="{{route('main')}}">Back to home page</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="footer-minimal section-single-footer">
                <div class="container">
                    <div class="footer-minimal-inner"><a class="brand" href="{{route('main')}}"> <img src="/images/logo-inverse-132x34.png" alt="" width="132" height="34" srcset="/images/logo-inverse-250x64.png 2x"/></a>
                        <!-- Rights-->
